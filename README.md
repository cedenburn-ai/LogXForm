...
- That the signal is *cognitive* rather than *stylometric*. Epistemic posture and writing register are confounded in text, and the residual dimensions are exactly where syntax and register live. LogXform may be a very good *stylometric* fingerprint wearing a cognitive name. The [style/structure disentanglement experiment](experiments-README.mdd#2-stylestructure-disentanglement) decides which.
